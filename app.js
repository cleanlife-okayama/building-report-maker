(function () {
  ...
  function buildFindingAiConsultationPrompt(finding) {
    ...
    return (
      ...
      "【欄ごとの考え方】\n" +
      "【確認した内容】は、現地で確認できた事実を書く欄です。写真や入力内容から分かる状態、劣化、不具合、周辺環境を中心にし、補修方法や対応方針は混ぜすぎないでください。例：屋根端部にサビや塗膜の傷みが見られます。／軒樋内部に水たまりや汚れの堆積が確認できます。\n" +
      "【考えられること・注意点】は、確認した内容をもとに、放置した場合の注意点や今後気をつけたいことを整理する欄です。不安をあおらず、原因・内部状態・将来必ず起こる被害は断定しないでください。例：サビが進むと、屋根材の傷みや補修範囲の広がりにつながる可能性があります。\n" +

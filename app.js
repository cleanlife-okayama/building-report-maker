(function () {
  ...
  function buildProposalAiConsultationPrompt() {
    ...
    return (
      ...
      "各欄の文字数目安内で、必要な説明は省略しすぎず、お客様が納得して判断できる文章にしてください。短くまとめることよりも、分かりやすく伝わることを優先してください。無理に文字数を増やさず、理由・背景・不安への配慮・対応する意味が自然に伝わる文章を優先してください。短い例を入れた方が伝わりやすい場合は、自然な範囲で入れてください。ただし、入力内容にない原因・工事内容・効果・危険性を断定して追加しないでください。\n\n" +
      "【最後にお伝えしたいことの考え方】\n" +
      "短い締め文だけで終わらせず、今回確認させていただいたことへのお礼、現時点で分かる範囲の受け止め、優先順位を分けて考える姿勢、足場設置後や工事中に再確認が必要な場合があること、追加で分かったことを説明しながら進めること、この報告書は工事を急がせるものではなく納得して判断いただくための資料であること、相談しやすいことを自然に含めてください。毎回すべてを機械的に入れず、入力内容、確認項目、写真情報、施工方針に合うものを選んでください。2〜4段落程度に分け、同じ内容の繰り返しは避けてください。「ぜひ当社にお任せください」「今すぐ工事しないと危険です」「必ず雨漏りします」「完全に直ります」「絶対に安心です」「放置すると大変なことになります」「他社より優れています」のような表現は使わないでください。\n\n" +
      "【重要な注意事項】\n" +
      "・入力内容にない劣化原因、工事内容、効果、危険性を断定しないでください。\n" +
      "・価格、保証、法的判断、効果の断定はしないでください。\n" +
      "・写真や入力内容から分からないことは断定しないでください。\n" +
  ...
  function proposalSupplementAiConfig(fieldKey) {
    const configs = {
      ...
      closing: {
        ...
        guidance:
          "この欄は、報告書の最後に、今回の確認内容、施工方針、注意点、今後の確認事項を踏まえて、お客様が安心して判断できるようにするための説明欄です。短い締め文ではなく、担当者の考え方、優先順位の分け方、確認しながら進める姿勢、相談しやすさが自然に伝わる文章として整えてください。必要に応じて、今回確認させていただいたことへのお礼、現時点で分かっている状態の受け止め、すぐ対応した方がよいことと経過を見ながら考えてよいことを分ける姿勢、写真や目視だけでは判断しきれない部分は足場設置後や工事中に再確認する場合があること、追加で分かったことがあればその都度説明しながら進めること、この報告書は工事を急がせるためではなくお客様が納得して判断するための資料であること、気になる点や分かりにくい点は相談しやすいこと、最後はやさしく自然に締めることを意識してください。ただし、これらを毎回すべて機械的に入れず、入力内容、確認項目、関連写真、施工方針に合うものを自然に選んでください。「現時点で分かる範囲では」「状態に応じて確認が必要です」「優先順位を分けて考えることが大切です」「必要な内容を確認しながら進めます」「ご不明な点はお気軽にご相談ください」「無理に工事を急がせるものではありません」「納得して判断いただけるよう、分かりやすくご説明します」「気になる点があれば、一つずつ確認しながら進めます」のような、判断しやすく相談しやすい表現を自然に使ってください。強い売り込み文にはせず、「ぜひ当社にお任せください」「今すぐ工事しないと危険です」「必ず雨漏りします」「完全に直ります」「絶対に安心です」「放置すると大変なことになります」「他社より優れています」「100％防げます」「必ず効果があります」のような表現は避けてください。500〜700文字程度のまとまった文章にし、文字数を埋めるための繰り返しは避け、2〜4段落程度で読みやすくしてください。",
      },
    };

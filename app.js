  ...
  function proposalSupplementAiConfig(fieldKey) {
    const configs = {
      ...
      cautions: {
        ...
        guidance:
          "施工中に確認しておくべき箇所、下地・漏水・劣化範囲・追加補修の可能性などを、分かりやすく整理してください。あとから「聞いていない」と感じにくいよう、「工事中に確認します」「状態に応じてご説明します」「必要な場合はその都度確認します」のように、確認しながら進める姿勢を少しはっきり伝えてください。ただし、追加工事や追加費用が必ず発生するような表現にはしないでください。",
      },
      watchPoint: {
        label: "今後注意しておきたい点",
      ...
      closing: {
        ...
        guidance:
          "この欄は、報告書の最後に、今回の確認内容、施工方針、注意点、今後の確認事項を踏まえて、お客様が安心して判断できるようにするための説明欄です。短い締め文ではなく、担当者の考え方、優先順位の分け方、確認しながら進める姿勢、相談しやすさが自然に伝わる文章として整えてください。回答本文は、必ず現地確認の機会をいただいたことへのお礼から始めてください。例として「このたびは、現地確認の機会をいただきありがとうございました。」のように書き、入力内容から自然に分かる場合は、屋根、波板、鉄部など確認した箇所を含めても構いません。続けて、今回確認した内容をもとに現在の状態と今後の対応目安を整理したこと、すぐ対応した方がよい部分と状態を見ながら考えてよい部分を分けて説明する姿勢、写真や目視だけでは判断しきれない部分は足場設置後や工事中に再確認する場合があること、追加で分かったことがあればその都度説明しながら進めることを自然に伝えてください。最後は、気になる点や分かりにくい点を一つずつ確認しながら進められることが伝わる、やさしい締めにしてください。ただし、これらを毎回すべて機械的に入れず、入力内容、確認項目、関連写真、施工方針に合うものを自然に選んでください。「現時点で分かる範囲では」「状態に応じて確認が必要です」「優先順位を分けて考えることが大切です」「必要な内容を確認しながら進めます」「ご不明な点はお気軽にご相談ください」「納得して判断いただけるよう、できるだけ分かりやすくお伝えします」「気になる点があれば、一つずつ確認しながら進めます」のような、判断しやすく相談しやすい表現を自然に使ってください。姿勢を自己評価として説明するのではなく、必要な対応と今後見ておきたい点を整理して伝える文章にしてください。断定しすぎる言い方、自社へ任せるよう強く促す言い方、他社との比較、完全・絶対・必ず・100%のような保証的な表現は避けてください。500〜700文字程度のまとまった文章にし、文字数を埋めるための繰り返しは避け、2〜4段落程度で読みやすくしてください。",
      },
    };

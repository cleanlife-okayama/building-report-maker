...
ご相談内容、今回の確認結果にもとづく目安、全体まとめにも、AI文章整形用の相談文コピー機能があります。参照する情報は機能ごとに異なり、報告書全体を毎回すべて外部AIへ渡すものではありません。
...
現在の全体まとめ、施工方針、確認項目、関連する写真情報を参考に、確認された状態、心配な点、対応の方向性を「全体のまとめ」として整理します。通常写真で非表示となる対応方針は参考情報に含めません。

...
7. 最後に「今回の調査結果にもとづく総合判断」へ、工事の必要性または判断保留、対応時期、優先箇所、その判断理由を入力します。
...
ご相談内容AIには、現在、専用のAI回答貼り戻し機能はありません。目安AIの6評価値も貼り戻し対象外で、担当者が選択した現在値を維持します。
...
確認項目と関連写真、今回の確認結果にもとづく目安を主な判断材料にして、工事が必要か不要か、詳しい確認後の判断か、いつ頃の対応が適切か、何を優先するか、その主な理由を整理します。判断は入力内容に応じて「現時点では工事不要」「経過確認が必要」「詳しい確認後に判断」「早めの対応が適切」「直ちに対応が必要」の考え方を使い分けます。施工方針は矛盾を防ぐためにだけ参照し、具体的な材料、工法、施工手順は「おすすめする施工方針」「主な工事内容」へ分けます。通常写真で非表示となる対応方針は参考情報に含めません。

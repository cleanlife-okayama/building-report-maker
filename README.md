...
3. 「調査写真」「確認箇所」に、写真ごとの場所・状態・現在の状態・この箇所の対応目安、箇所ごとの確認した内容・注意点・おすすめ対応を入力します。
...
- 確認した箇所ごとに「対応の目安」を選べます。
- 対応の目安は「経過観察」「要確認」「補修検討」「早めに対処」「優先対応」から選べます。
...
「AI相談画像」では、写真、写真タイトル、撮影箇所、調査結果の目安、現在の状態、この箇所の対応目安をまとめた画像を作成できます。

...
「AI相談画像」では、写真、写真タイトル、撮影箇所、調査結果・判断、現在の状態をまとめた画像を作成できます。ピックアップ写真と過去データの入力済み写真では、「この箇所の対応方針」も画像に含まれます。

写真に〇や矢印がある場合は、その箇所を優先して確認する指示がAI相談へ自動で含まれます。印があるだけで劣化や原因を確定するものではありません。印の位置をAIに確認させる場合は、AI相談画像も一緒に送ってください。
...
【現在の状態】【この箇所の対応方針】【確認した内容】【考えられること・注意点】【対応の考え方】【目安：緊急性】などの見出しを読み取り、反映前に候補内容を確認できます。写真の旧回答に含まれる【この箇所の対応目安】も引き続き読み取れます。
...
この機能は、AIに新しく診断させるものではありません。担当者が現場で確認して入力した内容と、紐づけた関連写真の情報を整理し、一般のお客様にも分かりやすい文章案を作るための補助機能です。

「確認した内容」が空欄でも、確認項目の「現在の状態」「今後の対応」や、関連写真の「調査結果・判断」「現在の状態」などに情報があれば使用できます。写真タイトルや撮影箇所だけでは確認結果の文章を作れないため、写真で確認できた状態や判断も入力してください。
